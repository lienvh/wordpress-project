...
import actions.commons.DataHelper;
...
public class Post01FlowCreateEditDeleteTest extends BaseTest {
    @Parameters("browser")
    @BeforeClass
    ...
    public void Post_02_Search_Created_Post_At_Admin_Site(Method method) {
        ...
        allPostsPage.inputToSearchTexbox(postTitle);
    ...
    public void Post_05_Search_Edited_Post_At_Admin_site(Method method) {
        ...
        allPostsPage.inputToSearchTexbox(postTitleEdited);
